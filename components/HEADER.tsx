...
export default function Nav() {
  return (
    ...
    <div className="bg-[#fafafa] flex justify-between items-center px-6 py-2 md:text-[11px] sm:text-[9px] text-[8px] font-medium text-gray-500">
      ...
      <div>
  <p className="text-black text-sm bg-white"></p>
</div>
      <div className="flex md:gap-4 sm:gap-3 gap-2">
        ...
        <Link href="http://localhost:3000/joinus" className="hover:text-gray-800">Join Us</Link>
        <Link href="http://localhost:3000/login" className="hover:text-gray-800">Sign In</Link>
      </div>
    </div>
